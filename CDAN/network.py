...
class ResNetFC(nn.Module):
    ...
    def output_num(self):
        return self.__in_features # class 분류 layer 직전의 feature dim
...
class AdversarialNetwork(nn.Module):
    def __init__(self, in_feature, hidden_size):
        ...
        self.ad_layer1 = nn.Linear(in_feature, hidden_size) # ( 256*31 -->1024 )
        self.relu1 = nn.ReLU()
        self.dropout1 = nn.Dropout(0.5)

        self.ad_layer2 = nn.Linear(hidden_size, hidden_size) # (1024, 1024)
        self.relu2 = nn.ReLU()
        self.dropout2 = nn.Dropout(0.5)

        self.ad_layer3 = nn.Linear(hidden_size, 1) # (1024, 1)
