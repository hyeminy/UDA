...
parser.add_argument('--source_dataset_code', type = str, default='visda_source')
parser.add_argument('--target_dataset_code', type = str, default='visda_target')
parser.add_argument('--tranfrom_type', type = str, default='visda_standard')
